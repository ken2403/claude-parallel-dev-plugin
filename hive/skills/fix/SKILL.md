---
name: fix
description: Address review feedback on a hive (or any) PR and update it — parallelizing across files with implementer subagents when the feedback spans 3+ independent files. Use after /hive:review requests changes, or to act on human review comments and push the fixes back to the PR.
...
Combine PR review comments, the latest `/hive:review` output, and any feedback
