...
assert_contains_normalized "$ROOT/ca/claude/skills/code-review/SKILL.md" "money/billing; external-input parsing"
assert_contains_normalized "$ROOT/ca/claude/skills/code-review/SKILL.md" "behavior change without a covering test"
assert_contains_normalized "$ROOT/ca/claude/skills/code-review/SKILL.md" "references/test-rigor.md"
assert_contains_normalized "$ROOT/ca/claude/skills/code-review/SKILL.md" "ca ships no subagents"
