...
| `/pw:wt-cleanup` | wtj環境をクリーンアップ | `job名` / `--all` |
...
/pw:rv <PR番号>
/pw:merge <PR番号> --skip
/pw:wt-cleanup add-dark-mode-toggle
```
...
**注意**: PRがマージされる前にworktreeを削除することは禁止されています。`wt-cleanup`はマージ済みのブランチのみ削除します。
