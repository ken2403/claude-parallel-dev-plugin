#!/usr/bin/env bash
# ==============================================================================
# Canonical base branch detection for the ha plugin.
#
# This is the SINGLE SOURCE OF TRUTH for base branch detection logic.
# ha skills that need a base branch use a byte-identical copy of this script
