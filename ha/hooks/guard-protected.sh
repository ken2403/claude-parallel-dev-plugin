...
# secret/credential file. ha builds features in worktrees; this is a cheap
# last line of defense against rewriting a .env or a key.
#
# Exit 0 = allow, exit 2 = block.
# ported from sa/hooks/guard-protected.sh (logic byte-identical; sa->ha strings)
# ==============================================================================
set -uo pipefail
...
if [ -n "${blocked:-}" ]; then
  echo "ha: refusing to edit sensitive file '$file_path'. If this is intentional, edit it manually or remove it from the guard list." >&2
  exit 2
fi
exit 0
